...
<body>
	...
	<form action="add" method="post">
		<table class="col-md-4 table table-striped mx-auto">
			<tr><td>id</td><td><input type="number" required name="empId" value="${emodel.empId}" /></td></tr>
			<tr><td>name</td><td><input type="text" required name="empName" value="${emodel.empName}" /></td></tr>
			<tr><td>sal</td><td><input type="number" required name="empSal" value="${emodel.empSal}" /></td></tr>
			<tr><td>dept</td>
